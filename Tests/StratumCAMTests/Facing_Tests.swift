...
//        let rows = engine.facingScanlines(stock: stock, extensionLength: 0, tool: tool, direction: .climb)
//
...
//        let rows = engine.facingScanlines(stock: stock, extensionLength: 3.0, tool: tool, direction: .climb)
//
