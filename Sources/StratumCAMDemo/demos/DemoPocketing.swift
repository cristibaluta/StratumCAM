...
class DemoPocketing: Demo {
    ...
    func demoPocketRectangle() -> Demo.DemoResult {
        ...
        let strategy: SC.Strategy = .pocket(direction: .climb, pocketType: .offsetPattern, entry: .plunge)
    ...
    func demoPocketRectangleConventional() -> Demo.DemoResult {
        ...
        let strategy: SC.Strategy = .pocket(direction: .conventional, pocketType: .offsetPattern, entry: .plunge)
